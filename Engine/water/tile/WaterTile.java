 ...
 * 
 * KullanÄ±cÄ± bu sÄ±nÄ±f Ã¼zerinden tÃ¼m okyanus gÃ¶rÃ¼nÃ¼mÃ¼nÃ¼
 * Ã¶zelleÅŸtirebilir:
 * Renk, saydamlÄ±k, dalga hÄ±zÄ±, dalga yÃ¼ksekliÄŸi, kÃ¶pÃ¼k, rÃ¼zgar
 * yÃ¶nÃ¼...
 *
...
public class WaterTile {
	...
	private float transparency = 0.44f;
	...
	// --- IÅžIK VE PARLAKLK ---
	/**
	 * GÃ¼neÅŸ yansÄ±masÄ±nÄ±n (specular) keskinliÄŸi: bÃ¼yÃ¼k deÄŸer = daha
	 * keskin/kÃ¼Ã§Ã¼k gÃ¼neÅŸ yolu
	 */
	...
	public void setBaseColor(Vector3f c) {
		this.baseColor.set(c);
	}
	...
	public void setDeepColor(Vector3f c) {
		this.deepColor.set(c);
	}

	public void setDeepColor(float r, float g, float b) {
		this.deepColor.set(r, g, b);
	}
	...
	/**
	 * Dalga yÃ¼ksekliÄŸi (varsayÄ±lan: 0.00045f). BÃ¼yÃ¼k deÄŸer = yÃ¼ksek
	 * dalgalar.
	 */
	...
	/**
	 * RÃ¼zgar hÄ±zÄ± m/s (varsayÄ±lan: 6.5). BÃ¼yÃ¼k deÄŸer = uzun/kuvvetli
	 * dalgalar.
	 */
	...
	public void setWindDirection(float x, float z) {
		this.windDirection.set(x, z);
	}

	public void setWindDirection(Vector2f dir) {
		this.windDirection.set(dir);
	}

	/**
	 * Dalga animasyon hÄ±zÄ± Ã§arpanÄ± (varsayÄ±lan: 1.0). BÃ¼yÃ¼k deÄŸer = hÄ±zlÄ±
	 * dalgalanma.
	 */
	...
	/**
	 * GÃ¼neÅŸ yansÄ±masÄ± keskinliÄŸi (varsayÄ±lan: 256). BÃ¼yÃ¼k deÄŸer = ince,
	 * keskin gÃ¼neÅŸ yolu.
	 */
	...
	/**
	 * Fresnel kuvveti (varsayÄ±lan: 3.5). BÃ¼yÃ¼k deÄŸer = kenarlarda daha fazla
	 * parlama.
	 */
	...
	public void setFresnelPower(float fresnelPower) {
	...
	public void setLightAmbient(Vector3f lightAmbient) {
	...
	public float getWaterHeightAt(float wx, float wz) {
		return this.height;
	}
	...
	public void setUnderwaterFogDensity(float d) {
		this.underwaterFogDensity = d;
	}

	public float getUnderwaterFogR() {
		return underwaterFogR;
	}

	public float getUnderwaterFogG() {
		return underwaterFogG;
	}

	public float getUnderwaterFogB() {
		return underwaterFogB;
	}
